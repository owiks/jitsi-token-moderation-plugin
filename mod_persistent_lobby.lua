...
local main_muc_component_host = module:get_option_string('main_muc', 'muc.meet.jitsi');
local lobby_muc_component_host = module:get_option_string('lobby_muc', 'lobby.meet.jitsi');
